    ...
    public static String[] getAllPhoneList() {
        ...
        for (int i = 0, l = wx008Datas.size(); i < l; i++) {
           ...
           /* if(wd.getDataFlag().equals("009")){
            ...
            System.out.println(showMsg+" --nickName:"+wd.getNickName()+" repPhone:"+wd.getReplacePhone()+" pwd:"+wd.getWxPwd()+" phone:"+wd.getPhone()+" wxid:"+wd.getWxid19()+" exp:"+wd.getExpMsg()+" pwd:"+wd.getWxPwd()+" friends:"+JSON.toJSONString(wd.getFriends())+"dieFlag:"+wd.getDieFlag());
            //删除测试
            //保护结束
