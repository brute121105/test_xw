...
public class CommonConstant {
    ...
    public static String APPCONFIG_USERNAME= "username";//帐号
    public static String APPCONFIG_PWD = "password";//密码
    public static String APPCONFIG_WY_TOKEN = "wyToken";//微移token
