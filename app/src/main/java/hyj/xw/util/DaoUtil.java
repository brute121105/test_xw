...
public class DaoUtil {
    ...
    public static List<Wx008Data> findByDataBydataFlag(){
        ...
        List<Wx008Data> wx008Datas = DataSupport.where("(dataFlag=? or dataFlag=? or dataFlag=?) and dieFlag!=? and (expMsg not like '%帐号%' or expMsg is null)","007","008","009","999").order("createTime asc").find(Wx008Data.class);
